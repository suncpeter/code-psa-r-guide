...
Results from the `Matching::Match()` function are identical to Stata's `nnmatch` program and can be replicated using the `MatchIt::matchit()` function.
